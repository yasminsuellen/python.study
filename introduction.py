...
# Variable names are case-sensitive -> the variable X is different than the variable x.
...
# alpha-numeric characters and underscores (A-z, 0-9, and _ ). Variable names with more than one word can be difficult
...
# Also, use the global keyword if you want to change a global variable inside a function. To change
